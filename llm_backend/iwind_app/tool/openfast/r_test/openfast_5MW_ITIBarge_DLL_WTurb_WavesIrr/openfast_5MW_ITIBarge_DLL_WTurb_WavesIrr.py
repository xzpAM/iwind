...
# rainbow_yu openfast.tool.openfast_5MW_ITIBarge_DLL_WTurb_WavesIrr 🐋✨

from deepwind_app.tool.base import BaseTool
import requests

_openfast_5MW_ITIBarge_DLL_WTurb_WavesIrr_DESCRIPTION = """这个工具是用来：这是5MW风力发电机在ITIBarge平台上的工具，适用于不规则波浪情况下的动态模拟，尤其适合浮式平台的海上风电场测试。并且模拟结果后对结果进行总结。
"""

class openfast_5MW_ITIBarge_DLL_WTurb_WavesIrr(BaseTool):
    name: str = "openfast_5MW_ITIBarge_DLL_WTurb_WavesIrr"
    description: str = _openfast_5MW_ITIBarge_DLL_WTurb_WavesIrr_DESCRIPTION
    parameters: dict = {
    "type": "object",
    "properties": {
        "fst": {
            "type": "object",
            "description": "Parameters extracted from 5MW_ITIBarge_DLL_WTurb_WavesIrr.fst",
            "properties": {
                "Echo": {
                    "type": "boolean",
        ...
        "notwr": {
            "type": "object",
            "description": "Parameters extracted from NRELOffshrBsline5MW_AeroDyn_Equil_noTwr.dat",
            "properties": {
                "StallMod": {
                    "type": "string",
                    "description": "Dynamic stall included [BEDDOES or STEADY] (unquoted string)"
                },
                "UseCm": {
                    "type": "string",
                    "description": "Use aerodynamic pitching moment model? [USE_CM or NO_CM] (unquoted string)"
                },
                "InfModel": {
                    "type": "string",
                    "description": "Inflow model [DYNIN or EQUIL] (unquoted string)"
                },
                "IndModel": {
                    "type": "string",
                    "description": "Induction-factor model [NONE or WAKE or SWIRL] (unquoted string)"
                },
                "AToler": {
                    "type": "number",
                    "description": "Induction-factor tolerance (convergence criteria) (-)"
                },
                "TLModel": {
                    "type": "string",
                    "description": "Tip-loss model (EQUIL only) [PRANDtl, GTECH, or NONE] (unquoted string)"
                },
                "HLModel": {
                    "type": "string",
                    "description": "Hub-loss model (EQUIL only) [PRANdtl or NONE] (unquoted string)"
                },
                "TwrShad": {
                    "type": "number",
                    "description": "Tower-shadow velocity deficit (-)"
                },
                "ShadHWid": {
                    "type": "number",
                    "description": "Tower-shadow half width (m)"
                },
                "T_Shad_Refpt": {
                    "type": "number",
                    "description": "Tower-shadow reference point (m)"
                },
                "AirDens": {
                    "type": "number",
                    "description": "Air density (kg/m^3)"
                ...
                "KinVisc": {
                    "type": "number",
                    "description": "Kinematic air viscosity [CURRENTLY IGNORED] (m^2/sec)"
                },
                "DTAero": {
                    "type": "string",
                    "description": "Time interval for aerodynamic calculations (sec)"
                },
                "NumFoil": {
                    "type": "number",
                    "description": "Number of airfoil files (-)"
                },
                "FoilNm": {
                    "type": "string",
                    "description": "Names of the airfoil files [NumFoil lines] (quoted strings)"
                },
                "BldNodes": {
                    "type": "number",
                    "description": "Number of blade nodes used for analysis (-)"
                },
                "RNodes_AeroTwst_DRNodes_Chord_NFoil_PrnElm": {
                    "type": "array",
                    "description": "Table data columns: RNodes, AeroTwst, DRNodes, Chord, NFoil, PrnElm",
                    "items": {
                        "type": "object",
                        "properties": {
                            "RNodes": {
        ...
        "aerodyn": {
            "type": "object",
            "description": "Parameters extracted from NRELOffshrBsline5MW_ITIBarge4_AeroDyn.dat",
            "properties": {
                "Echo": {
                    "type": "boolean",
                ...
                "BldNd_BlOutNd": {
                    "type": "string",
                    "description": "Future feature will allow selecting a portion of the nodes to output. Not implemented yet. (-)"
                }
            }
        },
        "elastodyn": {
            "type": "object",
            "description": "Parameters extracted from NRELOffshrBsline5MW_ITIBarge4_ElastoDyn.dat",
            "properties": {
                "Echo": {
                    "type": "boolean",
                    "description": "Echo input data to \"<RootName>.ech\" (flag)"
                ...
                "BldGagNd": {
                    "type": "number",
                    "description": "List of blade nodes that have strain gages [1 to BldNodes] (-) [unused if NBlGages=0]"
                },
                "\"BldPitch1\"_-_Pitch_angles_for_blades_1,_2,_and_3": {
                    "type": "array",
                    "description": "Table data columns: \"BldPitch1\", -, Pitch, angles, for, blades, 1,, 2,, and, 3",
                    "items": {
                        "type": "object",
                        "properties": {
                            "\"BldPitch1\"": {
                ...
                "\"NcIMUTAxs\"_-_Nacelle_IMU_translational_accelerations_(absolute)_in_the_nonrotating,_shaft_coordinate_system": {
                    "type": "array",
                    "description": "Table data columns: \"NcIMUTAxs\", -, Nacelle, IMU, translational, accelerations, (absolute), in, the, nonrotating,, shaft, coordinate, system",
                    "items": {
                        "type": "object",
                        "properties": {
                            "\"NcIMUTAxs\"": {
                ...
                "\"PtfmSurge\"_-_Platform_translational_surge,_sway,_and_heave_displacements": {
                    "type": "array",
                    "description": "Table data columns: \"PtfmSurge\", -, Platform, translational, surge,, sway,, and, heave, displacements",
                    "items": {
                        "type": "object",
                        "properties": {
                            "\"PtfmSurge\"": {
                ...
                "\"PtfmTAxt\"_-_Platform_translation_accelerations_(absolute)_in_the_tower-base_coordinate_system": {
                    "type": "array",
                    "description": "Table data columns: \"PtfmTAxt\", -, Platform, translation, accelerations, (absolute), in, the, tower-base, coordinate, system",
                    "items": {
                        "type": "object",
                        "properties": {
                            "\"PtfmTAxt\"": {
                ...
                "\"RootFxc1\"_-_Out-of-plane_shear,_in-plane_shear,_and_axial_forces_at_the_root_of_blade_1": {
                    "type": "array",
                    "description": "Table data columns: \"RootFxc1\", -, Out-of-plane, shear,, in-plane, shear,, and, axial, forces, at, the, root, of, blade, 1",
                    "items": {
                        "type": "object",
                        "properties": {
                            "\"RootFxc1\"": {
                ...
                "\"Spn1MLxb1\"_-_Blade_1_local_edgewise_bending,_flapwise_bending,_and_pitching_moments_at_span_station_1_(approx._50%_span)": {
                    "type": "array",
                    "description": "Table data columns: \"Spn1MLxb1\", -, Blade, 1, local, edgewise, bending,, flapwise, bending,, and, pitching, moments, at, span, station, 1, (approx., 50%, span)",
                    "items": {
                        "type": "object",
                        "properties": {
                            "\"Spn1MLxb1\"": {
                ...
                "\"RotThrust\"_-_Rotor_thrust_and_low-speed_shaft_0-_and_90-rotating_shear_forces_at_the_main_bearing": {
                    "type": "array",
                    "description": "Table data columns: \"RotThrust\", -, Rotor, thrust, and, low-speed, shaft, 0-, and, 90-rotating, shear, forces, at, the, main, bearing",
                    "items": {
                        "type": "object",
                        "properties": {
                            "\"RotThrust\"": {
                ...
                "\"TwrBsFxt\"_-_Fore-aft_shear,_side-to-side_shear,_and_vertical_forces_at_the_base_of_the_tower_(platform)": {
                    "type": "array",
                    "description": "Table data columns: \"TwrBsFxt\", -, Fore-aft, shear,, side-to-side, shear,, and, vertical, forces, at, the, base, of, the, tower, (platform)",
                    "items": {
                        "type": "object",
                        "properties": {
                            "\"TwrBsFxt\"": {
                ...
                "\"TwHt1MLxt\"_-_Local_side-to-side_bending,_fore-aft_bending,_and_yaw_moments_at_tower_gage_1_(approx._50%_elevation)": {
                    "type": "array",
                    "description": "Table data columns: \"TwHt1MLxt\", -, Local, side-to-side, bending,, fore-aft, bending,, and, yaw, moments, at, tower, gage, 1, (approx., 50%, elevation)",
                    "items": {
                        "type": "object",
                        "properties": {
                            "\"TwHt1MLxt\"": {
        ...
        "tower": {
            "type": "object",
            "description": "Parameters extracted from NRELOffshrBsline5MW_ITIBarge4_ElastoDyn_Tower.dat",
            "properties": {
                "NTwInpSt": {
                    "type": "number",
                ...
                "TwFAM2Sh(2)": {
                    "type": "number",
                    "description": "Mode 2, coefficient of x^2 term"
                },
                "TwFAM2Sh(4)": {
                    "type": "number",
        ...
        "feamooring": {
            "type": "object",
            "description": "Parameters extracted from NRELOffshrBsline5MW_ITIBarge4_FEAMooring.dat",
            "properties": {
                "Echo": {
                    "type": "boolean",
                    "description": "Echo input data to <RootName>.ech (flag)"
                ...
                "DT": {
                    "type": "string",
                    "description": "Communication interval for module (s)"
                },
                "NumLines": {
                    "type": "number",
                ...
                "NumElem": {
                    "type": "number",
                    "description": "Total number of elements per line"
                },
                "Gravity": {
                    "type": "string",
                    "description": "Gravitational acceleration (m/s^2)"
                ...
                "MaxIter": {
                    "type": "number",
                    "description": "Maximum number of static iterations"
                },
                "Eps": {
                    "type": "number",
                    "description": "Static iteration tolerance"
                },
                "LEAStiff": {
                    "type": "number",
                ...
                "LMassDen": {
                    "type": "number",
                    "description": "Mass per unit length of the element"
                },
                "LDMassDen": {
                    "type": "number",
                    "description": "Displaced mass per unit length of the element"
                },
                "LineCI": {
                    "type": "number",
                    "description": "The inertia force per unit length / unit accel."
                },
                "LineCD": {
                    "type": "number",
                    "description": "The drag force per unit length / unit relative vel squared."
                },
                "LUnstrLen": {
                    "type": "number",
                    "description": "Unstretched length"
                },
                "BottmStiff": {
                    "type": "number",
                    "description": "Seabed stiffness"
                },
                "423.422_LRadAnch_(m)": {
                    "type": "array",
                    "description": "Table data columns: 423.422, LRadAnch, (m)",
                    "items": {
                        "type": "object",
                        "properties": {
                            "423.422": {
                ...
                "Tension": {
                    "type": "number",
                    "description": "Initial top tension"
                },
                "GSL21": {
                    "type": "number",
                    "description": "The linear spring stiffness in x-direction between mooring & platform"
                },
                "GSL22": {
                    "type": "number",
                    "description": "The linear spring stiffness in y-direction between mooring & platform"
                },
                "GSL23": {
                    "type": "number",
                    "description": "The linear spring stiffness in z-direction between mooring & platform"
                },
                "SumPrint": {
                    "type": "boolean",
        ...
        "hydrodyn": {
            "type": "object",
            "description": "Parameters extracted from NRELOffshrBsline5MW_ITIBarge4_HydroDyn.dat",
            "properties": {
                "Echo": {
                    "type": "boolean",
                ...
                "SimplCd_SimplCdMG_SimplCa_SimplCaMG_SimplCp_SimplCpMG_SimplAxCa_SimplAxCaMG_SimplAxCa_SimplAxCaMG_SimplAxCp_SimplAxCpMG": {
                    "type": "array",
                    "description": "Table data columns: SimplCd, SimplCdMG, SimplCa, SimplCaMG, SimplCp, SimplCpMG, SimplAxCa, SimplAxCaMG, SimplAxCa, SimplAxCaMG, SimplAxCp, SimplAxCpMG",
                    "items": {
                        "type": "object",
                        "properties": {
                            "SimplCd": {
                ...
                "Dpth_DpthCd_DpthCdMG_DpthCa_DpthCaMG_DpthCp_DpthCpMG_DpthAxCa_DpthAxCaMG_DpthAxCa_DpthAxCaMG_DpthAxCp_DpthAxCpMG": {
                    "type": "array",
                    "description": "Table data columns: Dpth, DpthCd, DpthCdMG, DpthCa, DpthCaMG, DpthCp, DpthCpMG, DpthAxCa, DpthAxCaMG, DpthAxCa, DpthAxCaMG, DpthAxCp, DpthAxCpMG",
                    "items": {
                        "type": "object",
                        "properties": {}
                    }
        ...
        "map": {
            "type": "object",
            "description": "Parameters extracted from NRELOffshrBsline5MW_ITIBarge4_MAP.dat",
            "properties": {
                "LineType_Diam_MassDenInAir_EA_CB_CIntDamp_Ca_Cdn_Cdt": {
                    "type": "array",
                    "description": "Table data columns: LineType, Diam, MassDenInAir, EA, CB, CIntDamp, Ca, Cdn, Cdt",
                    "items": {
                        "type": "object",
                        "properties": {}
                    }
                },
                "Node_Type_X_Y_Z_M_B_FX_FY_FZ": {
                    "type": "array",
                    "description": "Table data columns: Node, Type, X, Y, Z, M, B, FX, FY, FZ",
                    "items": {
                        "type": "object",
                        "properties": {
                            "Node": {
                ...
                "Line_LineType_UnstrLen_NodeAnch_NodeFair_Flags": {
                    "type": "array",
                    "description": "Table data columns: Line, LineType, UnstrLen, NodeAnch, NodeFair, Flags",
                    "items": {
                        "type": "object",
                        "properties": {
                            "Line": {
        ...
        "moordyn": {
            "type": "object",
            "description": "Parameters extracted from NRELOffshrBsline5MW_ITIBarge4_MoorDyn.dat",
            "properties": {
                "Echo": {
                    "type": "boolean",
                    "description": "echo the input file data (flag)"
                },
                "Name_Diam_MassDen_EA_BA/-zeta_EI_Cd_Ca_CdAx_CaAx": {
                    "type": "array",
                    "description": "Table data columns: Name, Diam, MassDen, EA, BA/-zeta, EI, Cd, Ca, CdAx, CaAx",
                    "items": {
                        "type": "object",
                        "properties": {}
                    }
                },
                "ID_Attachment_X_Y_Z_M_V_CdA_CA": {
                    "type": "array",
                    "description": "Table data columns: ID, Attachment, X, Y, Z, M, V, CdA, CA",
                    "items": {
                        "type": "object",
                        "properties": {
                            "ID": {
                ...
                "ID_LineType_AttachA_AttachB_UnstrLen_NumSegs_Outputs": {
                    "type": "array",
                    "description": "Table data columns: ID, LineType, AttachA, AttachB, UnstrLen, NumSegs, Outputs",
                    "items": {
                        "type": "object",
                        "properties": {
                            "ID": {
                ...
                "cbot": {
                    "type": "number",
                    "description": "bottom damping (Pa-s/m)"
                },
                "dtIC": {
                    "type": "number",
        ...
        "servodyn": {
            "type": "object",
            "description": "Parameters extracted from NRELOffshrBsline5MW_ITIBarge4_ServoDyn.dat",
            "properties": {
                "Echo": {
                    "type": "boolean",
                    "description": "Echo input data to <RootName>.ech (flag)"
    ...
    async def execute(self, **kwargs):
        try:
            # 包装成服务端预期格式
            payload = {"updates": {}}
            for module_name in ['fst', 'notwr', 'aerodyn', 'elastodyn', 'tower', 'feamooring', 'hydrodyn', 'map', 'moordyn', 'servodyn']:
                if module_name in kwargs:
                    payload["updates"][module_name] = kwargs[module_name]

            url = "http://localhost:8002/openfast/r_test/openfast_5MW_ITIBarge_DLL_WTurb_WavesIrr"
