...
# rainbow_yu openfast.tool.openfast_5MW_OC3Spar_DLL_WTurb_WavesIrr 🐋✨

from deepwind_app.tool.base import BaseTool
import requests

_openfast_5MW_OC3Spar_DLL_WTurb_WavesIrr_DESCRIPTION = """这个工具是用来：这是OC3 Spar平台上的5MW风力发电机模型，适用于不规则波浪下的动态性能模拟，特别适合深水海域的风电场模拟。并且模拟结果后对结果进行总结。
"""

class openfast_5MW_OC3Spar_DLL_WTurb_WavesIrr(BaseTool):
    name: str = "openfast_5MW_OC3Spar_DLL_WTurb_WavesIrr"
    description: str = _openfast_5MW_OC3Spar_DLL_WTurb_WavesIrr_DESCRIPTION
    parameters: dict = {
    "type": "object",
    "properties": {
        "fst": {
            "type": "object",
            "description": "Parameters extracted from 5MW_OC3Spar_DLL_WTurb_WavesIrr.fst",
            "properties": {
                "Echo": {
                    "type": "boolean",
        ...
        "elastodyn": {
            "type": "object",
            "description": "Parameters extracted from NRELOffshrBsline5MW_OC3Hywind_ElastoDyn.dat",
            "properties": {
                "Echo": {
                    "type": "boolean",
                    "description": "Echo input data to \"<RootName>.ech\" (flag)"
        ...
        "tower": {
            "type": "object",
            "description": "Parameters extracted from NRELOffshrBsline5MW_OC3Hywind_ElastoDyn_Tower.dat",
            "properties": {
                "NTwInpSt": {
                    "type": "number",
        ...
        "feamooring": {
            "type": "object",
            "description": "Parameters extracted from NRELOffshrBsline5MW_OC3Hywind_FEAMooring.dat",
            "properties": {
                "Echo": {
                    "type": "boolean",
                    "description": "Echo input data to <RootName>.ech (flag)"
                ...
                "853.87_LRadAnch": {
                    "type": "array",
                    "description": "Table data columns: 853.87, LRadAnch",
                    "items": {
                        "type": "object",
                        "properties": {
                            "853.87": {
        ...
        "hydrodyn": {
            "type": "object",
            "description": "Parameters extracted from NRELOffshrBsline5MW_OC3Hywind_HydroDyn.dat",
            "properties": {
                "Echo": {
                    "type": "boolean",
                ...
                "0_100000_0_0_0_0": {
                    "type": "array",
                    "description": "Table data columns: 0, 100000, 0, 0, 0, 0",
                    "items": {
                        "type": "object",
                        "properties": {
                            "0": {
        ...
        "map": {
            "type": "object",
            "description": "Parameters extracted from NRELOffshrBsline5MW_OC3Hywind_MAP.dat",
            "properties": {
        ...
        "moordyn": {
            "type": "object",
            "description": "Parameters extracted from NRELOffshrBsline5MW_OC3Hywind_MoorDyn.dat",
            "properties": {
                "Echo": {
                    "type": "boolean",
                    "description": "echo the input file data (flag)"
        ...
        "servodyn": {
            "type": "object",
            "description": "Parameters extracted from NRELOffshrBsline5MW_OC3Hywind_ServoDyn.dat",
            "properties": {
                "Echo": {
                    "type": "boolean",
                    "description": "Echo input data to <RootName>.ech (flag)"
    ...
    async def execute(self, **kwargs):
        try:
            ...
            url = "http://localhost:8002/openfast/r_test/openfast_5MW_OC3Spar_DLL_WTurb_WavesIrr"
