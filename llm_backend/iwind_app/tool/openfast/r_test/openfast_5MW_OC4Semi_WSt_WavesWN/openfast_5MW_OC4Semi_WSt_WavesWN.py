...
# rainbow_yu openfast.tool.openfast_5MW_OC4Semi_WSt_WavesWN 🐋✨

from deepwind_app.tool.base import BaseTool
import requests

_openfast_5MW_OC4Semi_WSt_WavesWN_DESCRIPTION = """这个工具是用来：这是OC4 Semi平台的5MW风力发电机工具，适用于波浪作用下的风力机性能分析，适合半潜式平台（OC4 Semi）的风电场设计。并且模拟结果后对结果进行总结。
"""

class openfast_5MW_OC4Semi_WSt_WavesWN(BaseTool):
    name: str = "openfast_5MW_OC4Semi_WSt_WavesWN"
    description: str = _openfast_5MW_OC4Semi_WSt_WavesWN_DESCRIPTION
    parameters: dict = {
    "type": "object",
    "properties": {
        "fst": {
            "type": "object",
            "description": "Parameters extracted from 5MW_OC4Semi_WSt_WavesWN.fst",
            "properties": {
                "Echo": {
                    "type": "boolean",
        ...
        "aerodyn": {
            "type": "object",
            "description": "Parameters extracted from NRELOffshrBsline5MW_OC3Hywind_AeroDyn.dat",
            "properties": {
                "Echo": {
                    "type": "boolean",
        ...
        "aerodyn15": {
            "type": "object",
            "description": "Parameters extracted from NRELOffshrBsline5MW_OC3Hywind_AeroDyn15.dat",
            "properties": {
                "Echo": {
                    "type": "boolean",
                    "description": "Echo the input to \"<rootname>.AD.ech\"?  (flag)"
        ...
        "elastodyn": {
            "type": "object",
            "description": "Parameters extracted from NRELOffshrBsline5MW_OC4DeepCwindSemi_ElastoDyn.dat",
            "properties": {
                "Echo": {
                    "type": "boolean",
                    "description": "Echo input data to \"<RootName>.ech\" (flag)"
                ...
                "\"RotSpeed\"_-_Low-speed_shaft_speed": {
                    "type": "array",
                    "description": "Table data columns: \"RotSpeed\", -, Low-speed, shaft, speed",
                    "items": {
                        "type": "object",
                        "properties": {}
                    }
                },
                "\"OoPDefl1\"_-_Blade_1_out-of-plane_deflection": {
                    "type": "array",
                    "description": "Table data columns: \"OoPDefl1\", -, Blade, 1, out-of-plane, deflection",
                    "items": {
                        "type": "object",
                        "properties": {
                            "\"OoPDefl1\"": {
                ...
                "\"TTDspFA\"_-_Tower_fore-aft_deflection": {
                    "type": "array",
                    "description": "Table data columns: \"TTDspFA\", -, Tower, fore-aft, deflection",
                    "items": {
                        "type": "object",
                        "properties": {
                            "\"TTDspFA\"": {
                ...
                "\"PtfmSurge\"_-_Platform_translational_surge_displacement": {
                    "type": "array",
                    "description": "Table data columns: \"PtfmSurge\", -, Platform, translational, surge, displacement",
                    "items": {
                        "type": "object",
                        "properties": {
                            "\"PtfmSurge\"": {
                ...
                "\"RootFxc1\"_-_Out-of-plane_shear_force_at_the_root_of_blade_1": {
                    "type": "array",
                    "description": "Table data columns: \"RootFxc1\", -, Out-of-plane, shear, force, at, the, root, of, blade, 1",
                    "items": {
                        "type": "object",
                        "properties": {}
                    }
                },
                "\"RootMxc1\"_-_In-plane_bending_moment_at_the_root_of_blade_1": {
                    "type": "array",
                    "description": "Table data columns: \"RootMxc1\", -, In-plane, bending, moment, at, the, root, of, blade, 1",
                    "items": {
                        "type": "object",
                        "properties": {}
                    }
                },
                "\"YawBrFxp\"_-_Fore-aft_shear_force_at_the_top_of_the_tower_(not_rotating_with_nacelle_yaw)": {
                    "type": "array",
                    "description": "Table data columns: \"YawBrFxp\", -, Fore-aft, shear, force, at, the, top, of, the, tower, (not, rotating, with, nacelle, yaw)",
                    "items": {
                        "type": "object",
                        "properties": {}
                    }
                },
                "\"YawBrMxp\"_-_Side-to-side_bending_moment_at_the_top_of_the_tower_(not_rotating_with_nacelle_yaw)": {
                    "type": "array",
                    "description": "Table data columns: \"YawBrMxp\", -, Side-to-side, bending, moment, at, the, top, of, the, tower, (not, rotating, with, nacelle, yaw)",
                    "items": {
                        "type": "object",
                        "properties": {}
                    }
                },
                "\"TwrBsFxt\"_-_Fore-aft_shear_force_at_the_base_of_the_tower_(platform)": {
                    "type": "array",
                    "description": "Table data columns: \"TwrBsFxt\", -, Fore-aft, shear, force, at, the, base, of, the, tower, (platform)",
                    "items": {
                        "type": "object",
                        "properties": {}
                    }
                },
                "\"TwrBsMxt\"_-_Side-to-side_bending_moment_at_the_base_of_the_tower_(platform)": {
                    "type": "array",
                    "description": "Table data columns: \"TwrBsMxt\", -, Side-to-side, bending, moment, at, the, base, of, the, tower, (platform)",
                    "items": {
                        "type": "object",
                        "properties": {}
                    }
        ...
        "tower": {
            "type": "object",
            "description": "Parameters extracted from NRELOffshrBsline5MW_OC4DeepCwindSemi_ElastoDyn_Tower.dat",
            "properties": {
                "NTwInpSt": {
                    "type": "number",
        ...
        "feamooring": {
            "type": "object",
            "description": "Parameters extracted from NRELOffshrBsline5MW_OC4DeepCwindSemi_FEAMooring.dat",
            "properties": {
                "Echo": {
                    "type": "boolean",
                    "description": "Echo input data to <RootName>.ech (flag)"
                ...
                "837.6_LRadAnch_(m)": {
                    "type": "array",
                    "description": "Table data columns: 837.6, LRadAnch, (m)",
                    "items": {
                        "type": "object",
                        "properties": {
                            "837.6": {
                ...
                "Tension": {
                    "type": "number",
                    "description": "Initial top tension (N)"
                },
                "GSL21": {
                    "type": "number",
                ...
                "SumPrint": {
                    "type": "boolean",
                    "description": "Print summary data to <RootName>.FEAM.sum (flag) (currently unused)"
                },
                "OutFile": {
                    "type": "number",
                    "description": "Switch to determine where output will be placed: {1: in module output file only; 2: in glue code output file only; 3: both} (currently unused)"
                ...
                "\"FairT1,_AnchT1\"": {
                    "type": "array",
                    "description": "Table data columns: \"FairT1,, AnchT1\"",
                    "items": {
                        "type": "object",
                        "properties": {
                            "\"FairT1,": {
        ...
        "hydrodyn": {
            "type": "object",
            "description": "Parameters extracted from NRELOffshrBsline5MW_OC4DeepCwindSemi_HydroDyn.dat",
            "properties": {
                "Echo": {
                    "type": "boolean",
                ...
                "RdtnTMax": {
                    "type": "number",
                    "description": "Analysis time for wave radiation kernel calculations (sec) [only used when PotMod=1 and RdtnMod=1; determines RdtnDOmega=Pi/RdtnTMax in the cosine transform; MAKE SURE THIS IS LONG ENOUGH FOR THE RADIATION IMPULSE RESPONSE FUNCTIONS TO DECAY TO NEAR-ZERO FOR THE GIVEN PLATFORM!]"
                },
                "RdtnDT": {
                    "type": "number",
                    "description": "Time step for wave radiation kernel calculations (sec) [only used when PotMod=1 and ExctnMod>1 or RdtnMod>0; DT<=RdtnDT<=0.1 recommended; determines RdtnOmegaMax=Pi/RdtnDT in the cosine transform]"
                },
                "NBody": {
                    "type": "number",
                ...
                "3_2_3_4_-6.17_1025": {
                    "type": "array",
                    "description": "Table data columns: 3, 2, 3, 4, -6.17, 1025",
                    "items": {
                        "type": "object",
                        "properties": {}
                    }
        ...
        "map": {
            "type": "object",
            "description": "Parameters extracted from NRELOffshrBsline5MW_OC4DeepCwindSemi_MAP.dat",
            "properties": {
        ...
        "moordyn": {
            "type": "object",
            "description": "Parameters extracted from NRELOffshrBsline5MW_OC4DeepCwindSemi_MoorDyn.dat",
            "properties": {
                "Echo": {
                    "type": "boolean",
                    "description": "echo the input file data (flag)"
        ...
        "servodyn": {
            "type": "object",
            "description": "Parameters extracted from NRELOffshrBsline5MW_OC4DeepCwindSemi_ServoDyn.dat",
            "properties": {
                "Echo": {
                    "type": "boolean",
                    "description": "Echo input data to <RootName>.ech (flag)"
                ...
                "\"GenPwr\"_-_Electrical_generator_power": {
                    "type": "array",
                    "description": "Table data columns: \"GenPwr\", -, Electrical, generator, power",
                    "items": {
                        "type": "object",
                        "properties": {}
                    }
    ...
    async def execute(self, **kwargs):
        try:
            # 包装成服务端预期格式
            payload = {"updates": {}}
            for module_name in ['fst', 'aerodyn', 'aerodyn15', 'elastodyn', 'tower', 'feamooring', 'hydrodyn', 'map', 'moordyn', 'servodyn']:
                if module_name in kwargs:
                    payload["updates"][module_name] = kwargs[module_name]

            url = "http://localhost:8002/openfast/r_test/openfast_5MW_OC4Semi_WSt_WavesWN"
