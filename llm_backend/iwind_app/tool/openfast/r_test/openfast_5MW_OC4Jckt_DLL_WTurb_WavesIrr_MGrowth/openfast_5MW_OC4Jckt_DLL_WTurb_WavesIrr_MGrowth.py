...
# rainbow_yu openfast.tool.openfast_5MW_OC4Jckt_DLL_WTurb_WavesIrr_MGrowth 🐋✨

from deepwind_app.tool.base import BaseTool
import requests

_openfast_5MW_OC4Jckt_DLL_WTurb_WavesIrr_MGrowth_DESCRIPTION = """
OpenFAST 5MW OC4 Jacket 风机仿真工具，支持风-涡旋-波浪-多重波浪场耦合及海洋生长（Marine Growth）效应模拟。

该工具基于NREL OpenFAST框架，专门用于模拟导管架（Jacket）型海上风电机组的动态响应，考虑了海洋生物附着引起的额外阻力和质量效应。
并且模拟结果后对结果进行总结。
"""

class openfast_5MW_OC4Jckt_DLL_WTurb_WavesIrr_MGrowth(BaseTool):
    name: str = "openfast_5MW_OC4Jckt_DLL_WTurb_WavesIrr_MGrowth"
    description: str = _openfast_5MW_OC4Jckt_DLL_WTurb_WavesIrr_MGrowth_DESCRIPTION
    parameters: dict = {
    "type": "object",
    "properties": {
        "fst": {
            "type": "object",
            "description": "Parameters extracted from 5MW_OC4Jckt_DLL_WTurb_WavesIrr_MGrowth.fst",
            "properties": {
                "Echo": {
                    "type": "boolean",
        ...
        "aerodyn": {
            "type": "object",
            "description": "Parameters extracted from NRELOffshrBsline5MW_OC4Jacket_AeroDyn.dat",
            "properties": {
                "Echo": {
                    "type": "boolean",
                ...
                "UAStartRad": {
                    "type": "number",
                    "description": "Starting radius or dynamic stall (fraction of rotor radius [0.0,1.0]) [used only when UA_Mod>0; if line is missing UAStartRad=0]"
                },
                "UAEndRad": {
                    "type": "number",
        ...
        "aerodyn15": {
            "type": "object",
            "description": "Parameters extracted from NRELOffshrBsline5MW_OC4Jacket_AeroDyn15.dat",
            "properties": {
                "Echo": {
                    "type": "boolean",
                    "description": "Echo the input to \"<rootname>.AD.ech\"?  (flag)"
        ...
        "tower": {
            "type": "object",
            "description": "Parameters extracted from NRELOffshrBsline5MW_OC4Jacket_ElastoDyn_Tower.dat",
            "properties": {
                "NTwInpSt": {
                    "type": "number",
        ...
        "hydrodyn": {
            "type": "object",
            "description": "Parameters extracted from NRELOffshrBsline5MW_OC4Jacket_HydroDyn.dat",
            "properties": {
                "Echo": {
                    "type": "boolean",
        ...
        "withice": {
            "type": "object",
            "description": "Parameters extracted from NRELOffshrBsline5MW_OC4Jacket_HydroDyn_withIce.dat",
            "properties": {
                "Echo": {
                    "type": "boolean",
                    "description": "Echo the input file data (flag)"
        ...
        "servodyn": {
            "type": "object",
            "description": "Parameters extracted from NRELOffshrBsline5MW_OC4Jacket_ServoDyn.dat",
            "properties": {
                "Echo": {
                    "type": "boolean",
                    "description": "Echo input data to <RootName>.ech (flag)"
        ...
        "subdyn": {
            "type": "object",
            "description": "Parameters extracted from NRELOffshrBsline5MW_OC4Jacket_SubDyn.dat",
            "properties": {
                "Echo": {
                    "type": "boolean",
                ...
                "M2N1FKZe\"": {
                    "type": "array",
                    "description": "Axial force in leg 2 at K1L2 and in leg 4 at K1L4"
                },
                "M8N1FKZe\"": {
                    "type": "array",
                    "description": "Axial force in leg 2 and leg 4 at mudbrace level: MudbraceL2, MudbraceL4"
                },
                "-ReactFYss,": {
                    "type": "array",
                    "description": "ReactMXss, -ReactMYss, -ReactMZss, -ReactFZss\" - Base reactions: fore-aft shear, side-to-side shear, side-to-side moment, fore-aft moment, yaw moment, vertical force"
                }
            }
        }
    },
    ...
    async def execute(self, **kwargs):
        try:
            ...
            url = "http://localhost:8002/openfast/r_test/openfast_5MW_OC4Jckt_DLL_WTurb_WavesIrr_MGrowth"
