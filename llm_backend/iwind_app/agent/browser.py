...
from deepwind_app.prompt.browser import NEXT_STEP_PROMPT, SYSTEM_PROMPT
from deepwind_app.schema import Message, ToolChoice
from deepwind_app.tool import BrowserUseTool, Terminate, ToolCollection


# Avoid circular import if BrowserAgent needs BrowserContextHelper
if TYPE_CHECKING:
    from deepwind_app.agent.base import BaseAgent  # Or wherever memory is defined
